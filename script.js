  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!emailRegex.test(email)) {
        alert('אנא הכניסו כתובת דוא"ל תקינה');
        return;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Sharon משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '27b838d5-8846-4dc3-95e4-a5dbfc28761d',
                    name: data.name || '',
                    email: data.email || '',
